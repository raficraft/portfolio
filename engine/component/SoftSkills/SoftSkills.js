...
import { Wrapper_softSkills } from "./SoftSkilss_css";
    ...
    <Wrapper_softSkills>
      <div style={{ display: "flex", flexDirection: "column" }}>
        <header>
          ...
          <p className="text">
            Un bon développeur ce n'est pas seulement un package de compétences
            techniques. C'est aussi les soft skills ou encore "
            <b>compétences personnelles et sociales</b>", orientées vers les
            interactions humaines. Pour la bonne <b>cohésion d'une équipe</b> et
            pour mener à son terme les projets, ces compétences sont aussi,
        ...
        <article className="two_col">
          <div className="box_item">
            ...
            <p className="text">
              ...
              interlocuteur :<b>on veut le suivre</b>. Il est doté d'un{" "}
